      ...
      <div className="w-full py-8 px-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-4">
            ...
            {/* Activity Feed */}
            <div className="mt-6">
              <h3 className="font-semibold text-[#333333] mb-2 text-lg">Recent Activity</h3>
