                  ...
                  <div className="bg-[#F5F8FA] p-4">
                    ...
                    <div className="mt-4 p-2">
                      <button className="flex items-center gap-2 bg-F5F8FA text-[#007B87] px-4 py-2 border-0 border-[#007B87] rounded text-sm font-bold">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                          <path fill-rule="evenodd" clip-rule="evenodd" d="M18 11C18.5523 11 19 11.4477 19 12C19 12.5128 18.614 12.9355 18.1166 12.9933L18 13H6C5.44772 13 5 12.5523 5 12C5 11.4872 5.38604 11.0645 5.88338 11.0067L6 11H18Z" fill="#007B87"/>
                        </svg>
